...
<html>
<head>
	<title>IT Club || Community Service</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" role="navigation">
                <ul class="nav navbar-nav navbar-right" style="padding-top:13px;">
                    ...
                    <li class="active"><a href="community-service.php">Community Service</a></li>
    ...
    <div id="aboutus">
        <div class="container">
            ...
            <div class="row">
				...
				<h4>Club IT Community Service</h4>
                    Club IT is well known for its community service project called Cans for Credit. The first two weeks of December starts
					the collection of food that is eventually distributed to food pantries throughout the seven counties of the Lake Land district.
					<br>
                    <br>
					Members also continue to participate in a fall clean-up project which included raking leaves and picking up trash around Webb Hall.
                </div>
                <div class="col-sm-6">
